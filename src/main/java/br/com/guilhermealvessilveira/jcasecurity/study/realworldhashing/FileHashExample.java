package br.com.guilhermealvessilveira.jcasecurity.study.realworldhashing;

import br.com.guilhermealvessilveira.jcasecurity.study.utils.ByteUtils;
...
public class FileHashExample {
	...
	public static void main (final String[] args) throws IOException, NoSuchAlgorithmException {
		...
		try (final var fis = new FileInputStream(fileName)) {
			final var byteFile = ByteUtils.toByteArray(fis);
			final var md5File = MD5.toMd5Hash(byteFile);
